...
public class TheDecider {
	...
	public Outfit createColdOutfit(Preferences preferences, Wardrobe wardrobe) {
		...
		return new Outfit(tops.isEmpty() ? null : tops.get(0), 
				bottoms.isEmpty() ? null : bottoms.get(0), 
				socks.isEmpty() ? null : socks.get(0), 
				shoes.isEmpty() ? null : shoes.get(0),
				outerWear.isEmpty() ? null : outerWear.get(0), null, null);
	}
